...
class Page2(Page):
   def __init__(self, *args, **kwargs):
       ...
       self.p_ignition = tk.Label(self, text="Ignition\nPackets", bg="#4f2683", fg="white", anchor="w")
       self.p_ignition.grid(row=1,column=1)
       self.p_signal = tk.Label(self, text="Signal\nPackets", bg="gray", fg="white", anchor="w")
       self.p_signal.grid(row=2,column=1)
       self.p_blast = tk.Label(self, text="Blast Off\nPackets", bg="#4f2683", fg="white", anchor="w")
       self.p_blast.grid(row=3,column=1)
       self.p_apogee = tk.Label(self, text="Apogee\nPackets", bg="gray", fg="white", anchor="w")
       self.p_apogee.grid(row=4,column=1) 
       self.p_drogue = tk.Label(self, text="Drogue Chute\nPackets", bg="gray", fg="white", anchor="w")
       self.p_drogue.grid(row=1,column=2)
       self.p_main = tk.Label(self, text="Main Chute\nPackets", bg="#4f2683", fg="white", anchor="w")
       self.p_main.grid(row=2,column=2)
       self.p_touch = tk.Label(self, text="Touch Down\nPackets", bg="gray", fg="white", anchor="w")
       self.p_touch.grid(row=3,column=2)
       self.p_total = tk.Label(self, text="Total\nPackets", bg="#4f2683", fg="white", anchor="w")
       self.p_total.grid(row=4,column=2)
       
       self.p_ignition.configure(width=33,font=("Courier",15),padx=10,pady=10)
       self.p_signal.configure(width=33,font=("Courier",15),padx=10,pady=10)
       self.p_blast.configure(width=33,font=("Courier",15),padx=10,pady=10)
       self.p_apogee.configure(width=33,font=("Courier",15),padx=10,pady=10)
       self.p_drogue.configure(width=33,font=("Courier",15),padx=10,pady=10)
       self.p_main.configure(width=33,font=("Courier",15),padx=10,pady=10)
       self.p_touch.configure(width=33,font=("Courier",15),padx=10,pady=10)
       self.p_total.configure(width=33,font=("Courier",15),padx=10,pady=10)
